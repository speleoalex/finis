...
if ($m != "" && file_exists("{$_FN['src_finis']}/modules/$s/")) {
    $s = $m;
    $dirs = FN_ListDir("{$_FN['src_finis']}/modules/$s/", true, true);
    $_cms_strings = Local_LoadMessages("languages/it/lang.csv");
    dprint_r($_cms_strings);
    $strings = Local_LoadMessages("{$_FN['src_finis']}/modules/$s/languages/$lang/lang.csv", $_cms_strings);
    $dirs[] = "{$_FN['src_finis']}/modules/$s/";
    foreach ($dirs as $dir) {
...
} elseif ($s != "" && file_exists("{$_FN['src_application']}/sections/$s/")) {

    $dirs = FN_ListDir("{$_FN['src_application']}/sections/$s/", true, true);

    $_cms_strings = Local_LoadMessages("languages/it/lang.csv");
    //dprint_r($_cms_strings);
    $strings = Local_LoadMessages("{$_FN['src_application']}/sections/$s/languages/$lang/lang.csv", $_cms_strings);
    //dprint_r("file: sections/$s/languages/$lang/lang.csv");
    $dirs[] = "{$_FN['src_application']}/sections/$s/";
    foreach ($dirs as $dir) {
